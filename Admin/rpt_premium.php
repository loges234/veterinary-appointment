        ...
        <div class="row">
            <div class="page-header">
                <!-- <div class="d-flex align-items-center"> -->
                    <h1 align="center">Premium Plans Report</h1>
                <!-- </div> -->
            </div>
            </div>
            <!-- End Page Header -->
                                     ...
                                     <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                <tbody>
    <?php  
 $sql = "SELECT * FROM tbl_serviceprovider,tbl_plan_purchase where tbl_serviceprovider.id=tbl_plan_purchase.sp_id and plan_status='Activate' and plan_id='3'";
