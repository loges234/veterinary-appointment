            ...
            <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                      <br> <h4 align="center">Active Service Provider</h4><hr>
                                     <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                <tbody>
    <?php  
 $sql = "SELECT * FROM tbl_serviceprovider,tbl_plan_purchase where tbl_serviceprovider.id=tbl_plan_purchase.sp_id and plan_status='Activate'";
